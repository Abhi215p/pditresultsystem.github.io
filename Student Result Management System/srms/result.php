...
<html lang="en">
    <head>
        ...
        <title>PDIT Result Management System</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">PDIT Result Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">PDIT Student Result Details</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
<p><b>Student USsn :</b> <?php echo htmlentities($row->RollId);?>
